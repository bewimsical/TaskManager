...
public class CustomBossController implements Initializable {
    ...
    ObservableList<Chore> bossChores;

    private Pane parent;

    private final BossViewModel vm;

    public CustomBossController(BossViewModel vm, Pane parent) {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        bossChores = FXCollections.observableArrayList();
        bossChores.addListener((ListChangeListener<Chore>) change ->{
    ...
    @FXML
    void createBoss(MouseEvent event) {
        List<Chore> chores = new ArrayList<>(bossChores);
        Boss b = BossFactory.generate(nameField.getText(), chores);
        vm.addCustomBoss(b);
